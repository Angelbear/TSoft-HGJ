 ...
 * the License.
 */
package cn.edu.tsinghua.hpc.vcard;
...
public class VCardComposer {
    ...
    static {
        ...
        builder.appendQueryParameter("for_export_only"/*Data.FOR_EXPORT_ONLY*/, "1");
    ...
    private String createOneEntryInternal(final String contactId) {
        ...
        try {
            /*
            Method queryEntitiesMethod = Class.forName("android.content.ContentResolver")
                    .getMethod("queryEntities", new Class[] {
    ...
    private void appendVCardEmailLine(final StringBuilder builder,
        ...
        switch (typeAsPrimitive) {
            case Email.TYPE_CUSTOM: {
                ...
                if ("_AUTO_CELL"/*android.provider.Contacts.ContactMethodsColumns.MOBILE_EMAIL_TYPE_NAME*/
                        .equals(label)) {
