...
import cn.edu.tsinghua.hpc.tcontacts.model.ExchangeSource;
...
public class AttachImage extends Activity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (icicle != null) {
            ...
            Intent intent = new Intent(TIntent.ACTION_GET_CONTENT);
            ...
            if (extras != null && mRawContactIds != null) {
                ...
                if (photo != null) {
                    ...
                    for (Long rawContactId : mRawContactIds) {
                        ...
                        final Uri rawContactUri = ContentUris.withAppendedId(TRawContacts.CONTENT_URI,
                                rawContactId);
    ...
    private void insertPhoto(ContentValues values, Uri rawContactDataUri,
        ...
        try {
            mContentResolver.applyBatch(TContactsContract.AUTHORITY, operations);
