...
public class TabStripView extends LinearLayout {
    ...
    private void init() {
    	this.setDescendantFocusability(FLAG_USE_CHILD_DRAWING_ORDER);
        //mGroupFlags |= FLAG_USE_CHILD_DRAWING_ORDER;
        mBottomLeftStrip = this.getContext().getResources().getDrawable(
                R.drawable.tab_bottom);
        mBottomRightStrip = this.getContext().getResources().getDrawable(
                R.drawable.tab_bottom);
    }
