...
//				.fromParts("tel", number, null));
		Intent intent = new Intent(Intent.ACTION_CALL, Uri
				.fromParts("tel", number, null));				//add by chenqiang
	...
	private void initVoicemailButton() {
		...
		try {
			hasVoicemail = ((TelephonyManager)getSystemService(TELEPHONY_SERVICE)).getVoiceMailNumber() != null;
