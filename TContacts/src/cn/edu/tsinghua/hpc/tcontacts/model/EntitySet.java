...
public class EntitySet extends ArrayList<EntityDelta> implements Parcelable {
    ...
    public static EntitySet fromQuery(ContentResolver resolver, String selection,
		...
		try {
			...
			iterator = (EntityIterator) queryEntitiesMethod.invoke(resolver,
					new Object[] { TRawContacts.CONTENT_URI, selection,
							selectionArgs, sortOrder });

			// iterator = resolver.queryEntities(TRawContacts.CONTENT_URI,
			...
			throw new IllegalStateException("Problem querying contact details",
					e);
		} catch (Exception e) {
...
//                ContentProviderOperation.newUpdate(AggregationExceptions.CONTENT_URI);
    	//add by chenqiang
    	Builder builder =
            ContentProviderOperation.newUpdate(TAggregationExceptions.CONTENT_URI);
