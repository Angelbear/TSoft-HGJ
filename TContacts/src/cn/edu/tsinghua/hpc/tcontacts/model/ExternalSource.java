...
import cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.Tstyleable;
        ...
        try {
            ...
            while (((type = parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
                ...
                final TypedArray a = context.obtainStyledAttributes(attrs,
                        Tstyleable.ContactsDataKind);
                final DataKind kind = new DataKind();

                kind.mimeType = a
                        .getString(InternalResource.getStylable("ContactsDataKind_mimeType"));
                kind.iconRes = a.getResourceId(
                		InternalResource.getStylable("ContactsDataKind_icon"), -1);

                final String summaryColumn = a
                        .getString(InternalResource.getStylable("ContactsDataKind_summaryColumn"));
                ...
                final String detailColumn = a
                        .getString(InternalResource.getStylable("ContactsDataKind_detailColumn"));
                final boolean detailSocialSummary = a.getBoolean(
                		InternalResource.getStylable("ContactsDataKind_detailSocialSummary"),
                        false);
