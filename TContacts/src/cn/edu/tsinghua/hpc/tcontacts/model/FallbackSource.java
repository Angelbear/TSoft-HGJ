...
public class FallbackSource extends ContactsSource {
    ...
    protected DataKind inflateStructuredName(int inflateLevel) {
        ...
        if (inflateLevel >= ContactsSource.LEVEL_CONSTRAINTS) {
            ...
            //修改汉字提示，使其更加符合汉语习惯。 by Boern
            kind.fieldList.add(new EditField(StructuredName.GIVEN_NAME, R.string.name_family,
                    FLAGS_PERSON_NAME));//姓
            ...
            //修改汉字提示
            kind.fieldList.add(new EditField(StructuredName.FAMILY_NAME, R.string.name_given,
                    FLAGS_PERSON_NAME)); //名
