...
//        final IContentService cs = ContentResolver.getContentService();
        ...
        try {
        	Method getContentServiceMethod = Class.forName("android.content.ContentResolver").getMethod("getContentService", new Class[] {});
            getContentServiceMethod.setAccessible(true);
            final IContentService cs = (IContentService) getContentServiceMethod.invoke(null, new Object[]{});
    ...
    public ArrayList<Account> getAccounts(boolean writableOnly) {
        ...
        for (Account account : accounts) {
            ...
            //Add by LinHeng
            final boolean isGoogle = GoogleSource.ACCOUNT_TYPE.equals(account.type);
            Log.d("Accounts",account.name+" "+account.type);
            if (hasContacts && matchesWritable && !isGoogle) {
