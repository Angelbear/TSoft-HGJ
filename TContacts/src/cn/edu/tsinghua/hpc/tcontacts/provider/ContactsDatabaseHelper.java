 ...
 */
public /* package */ class ContactsDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS "
                ...
                AggregatedPresenceColumns.CONTACT_ID
                        ...
                        TStatusUpdates.PRESENCE_STATUS + " INTEGER" +
        ");");
        ...
        String replaceAggregatePresenceSql =
            ...
            " SELECT " + PresenceColumns.CONTACT_ID + ","
                        + "MAX(" + TStatusUpdates.PRESENCE_STATUS + ")" +
                    " FROM " + Tables.PRESENCE +
                    " WHERE " + PresenceColumns.CONTACT_ID
...
//                DataColumns.PACKAGE_ID + " INTEGER REFERENCES package(_id)," +
                //add by chenqiang
                DataColumns.PACKAGE_ID + " INTEGER REFERENCES packages(_id)," +
...
//                GroupsColumns.PACKAGE_ID + " INTEGER REFERENCES package(_id)," +
                GroupsColumns.PACKAGE_ID + " INTEGER REFERENCES packages(_id)," +
...
//        	Log.v(TAG, clusterId+"----------"+strings[clusterId]+"--------"+strings.length);
        	if(strings[clusterId]==null || strings[clusterId].length() == 0){//add by chenqiang
        		continue;
        	}
