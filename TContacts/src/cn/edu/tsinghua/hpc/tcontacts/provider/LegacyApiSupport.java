...
//        matcher.addURI(authority, "voice_dialer_timestamp", VOICE_DIALER_TIMESTAMP);
        ...
        sPeopleProjectionMap.put(TPeople.PRESENCE_STATUS, TPeople.PRESENCE_STATUS);
        sPeopleProjectionMap.put(TPeople.PRESENCE_CUSTOM_STATUS,
                ...
                " LIMIT 1" +
                ") AS " + TPeople.PRESENCE_CUSTOM_STATUS);
