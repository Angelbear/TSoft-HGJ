...
import cn.edu.tsinghua.hpc.tcontacts.util.TIntent.TLiveFolders;
...
public class ContactsLiveFolders {
    public static class StarredContacts extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (TLiveFolders.ACTION_CREATE_LIVE_FOLDER.equals(action)) {
    ...
    private static Intent createLiveFolder(Context context, Uri uri, String name,
        ...
        intent.putExtra(LiveFolders.EXTRA_LIVE_FOLDER_BASE_INTENT,
                new Intent(TIntent.ACTION_VIEW, TContacts.CONTENT_URI));
