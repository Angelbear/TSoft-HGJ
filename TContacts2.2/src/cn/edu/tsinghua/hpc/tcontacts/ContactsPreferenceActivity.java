...
public class ContactsPreferenceActivity extends PreferenceActivity implements
	...
	protected void onCreate(Bundle icicle) {
		...
		mSyncInterval = (CheckBoxPreference) findPreference("pref_key_contacts_transparent_sync");
	...
	private void setTSyncInterval(int interval) {
		getPreferenceScreen().getSharedPreferences().edit()
				.putInt("sync_interval", interval).commit();
		...
		if (key.equals(TRANSPARENT_SYNC)) {
			...
			if (isTsyncEnabled) {
				alarmManager.setRepeating(AlarmManager.RTC_WAKEUP,
						...
						1000 * 60 * getTSyncInterval(this), pendingIntent);
