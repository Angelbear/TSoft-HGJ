...
public class ContactsSearchManager {
    ...
    private static Intent buildIntent(Activity context, String initialQuery) {
        Intent intent = new Intent(context,ContactsListActivity.ContactsSearchActivity.class);
        intent.setData(TContactsContract.TContacts.CONTENT_URI);
        intent.setAction(TContactsContract.Intents.UI.FILTER_CONTACTS_ACTION);
        ...
        intent.putExtra(TContactsContract.Intents.UI.FILTER_TEXT_EXTRA_KEY, initialQuery);
