...
public class DialtactsActivity extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        if (intent.getAction().equals(TContactsContract.Intents.UI.FILTER_CONTACTS_ACTION)
                && icicle == null) {
        	Log.d(TAG,"setupFilterText");
    ...
    private void fixIntent(Intent intent) {
        ...
        if (TIntent.ACTION_CALL_BUTTON.equals(intent.getAction())) {
            intent.setDataAndType(TCalls.CONTENT_URI, Calls.CONTENT_TYPE);
    ...
    private void setupCallLogTab() {
        ...
        mTabHost.addTab(mTabHost.newTabSpec("tcall_log")
    ...
    private void setupContactsTab() {
        Intent intent = new Intent(TContactsContract.Intents.UI.LIST_DEFAULT);
    ...
    private void setupFavoritesTab() {
        Intent intent = new Intent(TContactsContract.Intents.UI.LIST_STREQUENT_ACTION);
        intent.setClass(this, ContactsListActivity.class);
    ...
    public void onNewIntent(Intent newIntent) {
        ...
        if (action.equals(TContactsContract.Intents.UI.FILTER_CONTACTS_ACTION)) {
    ...
    private boolean isDialIntent(Intent intent) {
        ...
        if (TIntent.ACTION_VIEW.equals(action)) {
    ...
    private void setupFilterText(Intent intent) {
        ...
        String filter = intent.getStringExtra(TContactsContract.Intents.UI.FILTER_TEXT_EXTRA_KEY);
