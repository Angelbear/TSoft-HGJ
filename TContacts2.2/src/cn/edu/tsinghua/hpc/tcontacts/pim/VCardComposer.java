...
import cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TContactMethodsColumns;
...
public class VCardComposer {
    ...
    static {
        Uri.Builder builder = TRawContacts.CONTENT_URI.buildUpon();
        builder.appendQueryParameter(TData.FOR_EXPORT_ONLY, "1");
    ...
    public boolean init(final String selection, final String[] selectionArgs) {
        ...
        if (mIsCallLogComposer) {
            mCursor = mContentResolver.query(TCalls.CONTENT_URI, sCallLogProjection,
                    selection, selectionArgs, null);
        } else {
            mCursor = mContentResolver.query(TContacts.CONTENT_URI, sContactsProjection,
                    selection, selectionArgs, null);
        }
    ...
    public String exportOneContactData(String localId)
    {
    	return createOneEntryInternal(localId);
    }
    
    private String createOneEntryInternal(final String contactId) {
        final Map<String, List<ContentValues>> contentValuesListMap =
                new HashMap<String, List<ContentValues>>();
        final Uri uri = TRawContactsEntity.CONTENT_URI.buildUpon().appendQueryParameter(TData.FOR_EXPORT_ONLY, "1").build();
        ...
        try {
        	/*
			Method queryEntitiesMethod = Class.forName(
					"android.content.ContentResolver").getMethod(
					"queryEntities",
					new Class[] { Uri.class, String.class, String[].class,
							String.class });
			queryEntitiesMethod.setAccessible(true);
			entityIterator = (EntityIterator) queryEntitiesMethod.invoke(mContentResolver,
					new Object[] {
    ...
    private void appendVCardEmailLine(final StringBuilder builder,
        ...
        switch (typeAsPrimitive) {
            case Email.TYPE_CUSTOM: {
                ...
                if (TContactMethodsColumns.MOBILE_EMAIL_TYPE_NAME
                        .equals(label)) {
