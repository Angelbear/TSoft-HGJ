...
import cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.CommonDataKinds.TOrganization;
...
*/
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        /**
         * This table stores the infomation for TSync
         */
    ...
    private void loadNicknameLookupTable(SQLiteDatabase db) {
        ...
        try {
            for (int clusterId = 0; clusterId < strings.length; clusterId++) {
            	//add by chenqiang
            	if(strings[clusterId]==null||strings[clusterId].length()==0||strings[clusterId].contains(",")==false){
            		return;
            	}
