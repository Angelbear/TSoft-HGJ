...
public class ButtonGridLayout extends ViewGroup {
    ...
    protected void onFinishInflate () {
        ...
        mWidthInc = mButtonWidth + this.getPaddingLeft() + this.getPaddingRight();
        mHeightInc = mButtonHeight + this.getPaddingTop() + this.getPaddingBottom();
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int y = (bottom - top) - mHeight + this.getPaddingTop();
