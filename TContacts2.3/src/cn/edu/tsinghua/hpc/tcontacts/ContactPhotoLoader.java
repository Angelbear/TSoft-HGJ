...
import cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TContacts.TPhoto;
...
public class ContactPhotoLoader implements Callback {
    ...
    private final String[] COLUMNS = new String[] { Photo._ID, TPhoto.PHOTO };
    ...
    private class LoaderThread extends HandlerThread implements Callback {
        ...
        private void loadPhotosFromDatabase() {
            ...
            Cursor cursor = null;
            try {
                cursor = mResolver.query(TData.CONTENT_URI,
                        COLUMNS,
