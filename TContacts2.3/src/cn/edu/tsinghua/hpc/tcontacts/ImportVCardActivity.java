        ...
        public void run() {
            ...
            try {
                if (mUri != null) {  // Read one vCard expressed by mUri
                    ...
                    TMethod.setProgressNumberFormat(mProgressDialogForReadVCard, "");
                    ...
                    TMethod.setProgressNumberFormat(mProgressDialogForReadVCard, getString(R.string.reading_vcard_contacts));
                    //mProgressDialogForReadVCard.setProgressNumberFormat(
                	...
                	TMethod.setProgressNumberFormat(mProgressDialogForReadVCard, getString(R.string.reading_vcard_files));
                    //mProgressDialogForReadVCard.setProgressNumberFormat(
