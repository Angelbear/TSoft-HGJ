		...
		try {
			...
			while (((type = parser.next()) != XmlPullParser.END_TAG || parser
				...
				final TypedArray a = context.obtainStyledAttributes(attrs,
						HiddenResource.getStylableArray("ContactsDataKind") /*android.R.styleable.ContactsDataKind*/);
				final DataKind kind = new DataKind();

				kind.mimeType = a.getString(InternalResource
						.getStylable("ContactsDataKind_mimeType")/*
																 * com.android.
																 * internal
																 * .R.styleable.
				...
				kind.iconRes = a.getResourceId(
						InternalResource.getStylable("ContactsDataKind_icon")/*com.android.internal.R.styleable.ContactsDataKind_icon*/,
						-1);

				final String summaryColumn = a
						.getString(InternalResource.getStylable("ContactsDataKind_summaryColumn")/*com.android.internal.R.styleable.ContactsDataKind_summaryColumn*/);
				...
				final String detailColumn = a
						.getString(InternalResource.getStylable("ContactsDataKind_detailColumn")/*com.android.internal.R.styleable.ContactsDataKind_detailColumn*/);
				final boolean detailSocialSummary = a
						.getBoolean(
								InternalResource.getStylable("ContactsDataKind_detailSocialSummary")/*com.android.internal.R.styleable.ContactsDataKind_detailSocialSummary*/,
								false);
