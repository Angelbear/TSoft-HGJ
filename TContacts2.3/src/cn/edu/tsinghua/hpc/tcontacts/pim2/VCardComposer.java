 ...
 * the License.
 */
package cn.edu.tsinghua.hpc.tcontacts.pim2;
...
public class VCardComposer {
    ...
    static {
        ...
        builder.appendQueryParameter(cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TData.FOR_EXPORT_ONLY, "1");
    ...
    private String createOneEntryInternal(final String contactId) {
        ...
        final Uri uri = TRawContactsEntity.CONTENT_URI.buildUpon().appendQueryParameter(cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TData.FOR_EXPORT_ONLY, "1").build();
        ...
        try {/*
			...
			entityIterator = (EntityIterator) queryEntitiesMethod.invoke(
					mContentResolver, new Object[] { sDataRequestUri,
							selection, selectionArgs, null });
			*/
    ...
    private void appendVCardEmailLine(final StringBuilder builder,
        ...
        switch (typeAsPrimitive) {
            case Email.TYPE_CUSTOM: {
                ...
                if (cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TContactMethodsColumns.MOBILE_EMAIL_TYPE_NAME
                        .equals(label)) {
