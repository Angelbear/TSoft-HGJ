...
public class CallLogProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI(TCallLog.AUTHORITY, "calls", CALLS);
        sURIMatcher.addURI(TCallLog.AUTHORITY, "calls/#", CALLS_ID);
        sURIMatcher.addURI(TCallLog.AUTHORITY, "calls/filter/*", CALLS_FILTER);
    }
	...
	sCallsProjectionMap.put(TCalls.TYPE_DIAL, TCalls.TYPE_DIAL);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (c != null) {
            c.setNotificationUri(getContext().getContentResolver(), TCallLog.CONTENT_URI);
        }
        return c;
    }
    ...
    public int update(Uri url, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (matchedUriId) {
            ...
            case CALLS_ID:
                where = TMethod.concatenateWhere(selection, Calls._ID + "="
    ...
    protected void notifyChange() {
        getContext().getContentResolver().notifyChange(TCallLog.CONTENT_URI, null,
