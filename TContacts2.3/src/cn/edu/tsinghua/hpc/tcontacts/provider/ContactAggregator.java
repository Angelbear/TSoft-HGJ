...
import cn.edu.tsinghua.hpc.tcontacts.provider.ContactMatcher.MatchScore;
...
public class ContactAggregator {
    ...
    private static class DisplayNameCandidate {
        ...
        public void clear() {
            rawContactId = -1;
            displayName = null;
            displayNameSource = TDisplayNameSources.UNDEFINED;
            verified = false;
    ...
    public ContactAggregator(ContactsProvider2 contactsProvider,
        ...
        final String replaceAggregatePresenceSql =
                ...
                + TStatusUpdates.PRESENCE_STATUS + ","
                + TStatusUpdates.CHAT_CAPABILITY
                + " FROM " + Tables.PRESENCE
                + " WHERE "
                + " (" + StatusUpdates.PRESENCE_STATUS
                +       " * 10 + " + TStatusUpdates.CHAT_CAPABILITY + ")"
                + " = (SELECT "
