...
public class ContactLocaleUtils {
    ...
    private ContactLocaleUtilsBase getForNameLookup(Integer nameStyle) {
        ...
        if (CHINESE_LANGUAGE.equals(mLanguage) && nameStyleInt == TFullNameStyle.WESTERN) {
            adjustedUtil = Integer.valueOf(TFullNameStyle.CHINESE);
        }
    ...
    private synchronized ContactLocaleUtilsBase get(Integer nameStyle) {
        ...
        if (utils == null) {
            if (nameStyle.intValue() == TFullNameStyle.CHINESE) {
    ...
    private int getAdjustedStyle(int nameStyle) {
        if (nameStyle == TFullNameStyle.CJK  && !JAPANESE_LANGUAGE.equals(mLanguage) &&
