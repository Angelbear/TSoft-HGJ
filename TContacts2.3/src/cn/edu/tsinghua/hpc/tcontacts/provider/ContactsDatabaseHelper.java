...
import cn.edu.tsinghua.hpc.tcontacts.util.TCallLog.TCalls;
...
import cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TCommonDataKinds.TOrganization;
...
*/
    ...
    public interface RawContactsColumns {
        ...
        public static final String CONCRETE_IS_RESTRICTED =
                Tables.RAW_CONTACTS + "." + TRawContacts.IS_RESTRICTED;

        public static final String DISPLAY_NAME = TRawContacts.DISPLAY_NAME_PRIMARY;
        public static final String DISPLAY_NAME_SOURCE = TRawContacts.DISPLAY_NAME_SOURCE;
        ...
        public static final String CONCRETE_NAME_VERIFIED =
                Tables.RAW_CONTACTS + "." + TRawContacts.NAME_VERIFIED;
    }
    ...
    public void onOpen(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + DATABASE_PRESENCE + "." + Tables.PRESENCE + " ("+
                ...
                TStatusUpdates.CHAT_CAPABILITY + " INTEGER NOT NULL DEFAULT 0," +
        ...
        final String replaceAggregatePresenceSql =
                ...
                + " WHERE "
                    + " (ifnull(" + StatusUpdates.PRESENCE + ",0)  * 10 "
                            + "+ ifnull(" + TStatusUpdates.CHAT_CAPABILITY + ", 0))"
                    + " = (SELECT "
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE transparent_sync (" +
//        		"_id INTERGER PRIMARY KEY," + 
        ...
        db.execSQL("CREATE TABLE " + Tables.CONTACTS + " (" +
                ...
                "sync_state TEXT DEFAULT 'present'," +
                TContacts.NAME_RAW_CONTACT_ID + " INTEGER REFERENCES raw_contacts(_id)," +
        ...
        db.execSQL("CREATE TABLE " + Tables.RAW_CONTACTS + " (" +
                ...
                "guid INTEGER DEFAULT -1,"+
                "sync_state TEXT DEFAULT 'present'," +
                TRawContacts.IS_RESTRICTED + " INTEGER DEFAULT 0," +
                ...
                TRawContacts.DISPLAY_NAME_PRIMARY + " TEXT," +
                TRawContacts.DISPLAY_NAME_ALTERNATIVE + " TEXT," +
                TRawContacts.DISPLAY_NAME_SOURCE + " INTEGER NOT NULL DEFAULT " +
                        TDisplayNameSources.UNDEFINED + "," +
                        TRawContacts.PHONETIC_NAME + " TEXT," +
                        TRawContacts.PHONETIC_NAME_STYLE + " TEXT," +
                        TRawContacts.SORT_KEY_PRIMARY + " TEXT COLLATE " +
                        ContactsProvider2.PHONEBOOK_COLLATOR_NAME + "," +
                        TRawContacts.SORT_KEY_ALTERNATIVE + " TEXT COLLATE " +
                        ContactsProvider2.PHONEBOOK_COLLATOR_NAME + "," +
                        TRawContacts.NAME_VERIFIED + " INTEGER NOT NULL DEFAULT 0," +
...
*/
    ...
    private static void createContactsViews(SQLiteDatabase db) {
        ...
        String dataColumns =
                ...
                + Data.DATA_VERSION + ", "
                + PackagesColumns.PACKAGE + " AS " + TData.RES_PACKAGE + ","
        ...
        String syncColumns =
                ...
                + RawContactsColumns.CONCRETE_NAME_VERIFIED + " AS " + TRawContacts.NAME_VERIFIED + ","
        ...
        String contactNameColumns =
                "name_raw_contact." + TRawContacts.DISPLAY_NAME_SOURCE
                        + " AS " + TContacts.DISPLAY_NAME_SOURCE + ", "
                + "name_raw_contact." + TRawContacts.DISPLAY_NAME_PRIMARY
                        + " AS " + TContacts.DISPLAY_NAME_PRIMARY + ", "
                + "name_raw_contact." + TRawContacts.DISPLAY_NAME_ALTERNATIVE
                        + " AS " + TContacts.DISPLAY_NAME_ALTERNATIVE + ", "
                + "name_raw_contact." + TRawContacts.PHONETIC_NAME
                        + " AS " + TContacts.PHONETIC_NAME + ", "
                + "name_raw_contact." + TRawContacts.PHONETIC_NAME_STYLE
                        + " AS " + TContacts.PHONETIC_NAME_STYLE + ", "
                + "name_raw_contact." + TRawContacts.SORT_KEY_PRIMARY
                        + " AS " + TContacts.SORT_KEY_PRIMARY + ", "
                + "name_raw_contact." + TRawContacts.SORT_KEY_ALTERNATIVE
                        + " AS " + TContacts.SORT_KEY_ALTERNATIVE + ", "
                + "name_raw_contact." + TRawContacts.CONTACT_IN_VISIBLE_GROUP
        ...
        String dataSelect = "SELECT "
                ...
                +   TContacts.NAME_RAW_CONTACT_ID + "=name_raw_contact." + RawContacts._ID + ")"
        ...
        db.execSQL("CREATE VIEW " + Views.RAW_CONTACTS_RESTRICTED + " AS " + rawContactsSelect
                + " WHERE " + TRawContacts.IS_RESTRICTED + "=0");

        String contactsColumns =
                ContactsColumns.CONCRETE_CUSTOM_RINGTONE
                        + " AS " + Contacts.CUSTOM_RINGTONE + ", "
                + contactNameColumns + ", "
                + "contacts.guid" + " AS " +"guid"+ ", "
                + "contacts.sync_state" + " AS " +"sync_state" +", "
                + Contacts.HAS_PHONE_NUMBER + ", "
                + Contacts.LOOKUP_KEY + ", "
                + Contacts.PHOTO_ID + ", "
                + ContactsColumns.CONCRETE_LAST_TIME_CONTACTED
    ...
    private static void createGroupsView(SQLiteDatabase db) {
        ...
        String groupsColumns =
                ...
                + Groups.SYNC3 + ","
                + Groups.SYNC4 + ","
                + PackagesColumns.PACKAGE + " AS " + TGroups.RES_PACKAGE;
    ...
    private static void createContactEntitiesView(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE VIEW " + Tables.CONTACT_ENTITIES_RESTRICTED + " AS "
                + contactEntitiesSelect + " WHERE " + TRawContacts.IS_RESTRICTED + "=0");
    }
...
//            db.execSQL("DROP TABLE IF EXISTS " + Tables.ACTIVITIES + ";");
    ...
    private void upgradeToVersion203(SQLiteDatabase db) {
        ...
        db.execSQL(
                ...
                " ADD " + TContacts.NAME_RAW_CONTACT_ID + " INTEGER REFERENCES raw_contacts(_id)");
        db.execSQL(
        ...
        db.execSQL(
                "UPDATE " + Tables.CONTACTS +
                " SET " + TContacts.NAME_RAW_CONTACT_ID + "=(" +
        ...
        db.execSQL(
                ...
                " SET " + TContacts.NAME_RAW_CONTACT_ID + "=(" +
                        ...
                        " ORDER BY " + RawContacts._ID +
                        " LIMIT 1)" +
                " WHERE " + TContacts.NAME_RAW_CONTACT_ID + " IS NULL"
        );
    ...
    private void upgradeToVersion205(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + TRawContacts.DISPLAY_NAME_ALTERNATIVE + " TEXT;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + TRawContacts.PHONETIC_NAME + " TEXT;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + TRawContacts.PHONETIC_NAME_STYLE + " INTEGER;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + TRawContacts.SORT_KEY_PRIMARY
                + " TEXT COLLATE " + ContactsProvider2.PHONEBOOK_COLLATOR_NAME + ";");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + TRawContacts.SORT_KEY_ALTERNATIVE
                + " TEXT COLLATE " + ContactsProvider2.PHONEBOOK_COLLATOR_NAME + ";");
    ...
    private void upgradeStructuredNamesToVersion205(SQLiteDatabase db,
        ...
        SQLiteStatement structuredNameUpdate = db.compileStatement(
                "UPDATE " + Tables.DATA +
                " SET " +
                        TStructuredName.FULL_NAME_STYLE + "=?," +
                        StructuredName.DISPLAY_NAME + "=?," +
                        TStructuredName.PHONETIC_NAME_STYLE + "=?" +
                " WHERE " + Data._ID + "=?");
    ...
    private void upgradeNameToVersion205(long dataId, long rawContactId, int displayNameSource,
        ...
        if (displayNameSource == TDisplayNameSources.STRUCTURED_NAME) {
            ...
            } else if (name.fullNameStyle == TFullNameStyle.CHINESE ||
                    name.fullNameStyle == TFullNameStyle.CJK) {
        ...
        try {
            while (cursor.moveToNext()) {
                ...
                if (phoneticName == null && company != null) {
                    ...
                    if (nameStyle == TFullNameStyle.CHINESE ||
                            nameStyle == TFullNameStyle.CJK ) {
    ...
    private void upgrateToVersion206(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + TRawContacts.NAME_VERIFIED + " INTEGER NOT NULL DEFAULT 0;");
    }
