...
import cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TCommonDataKinds.TStructuredName;
...
import cn.edu.tsinghua.hpc.tcontacts.util.TContactsContract.TStatusUpdates;
...
public class ContactsProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    private static final boolean VERBOSE_LOGGING = true;//Log.isLoggable(TAG, Log.VERBOSE);
    ...
    static {
        ...
        sContactsProjectionMap.put(TContacts.DISPLAY_NAME_SOURCE, TContacts.DISPLAY_NAME_SOURCE);
        sContactsProjectionMap.put(TContacts.PHONETIC_NAME, TContacts.PHONETIC_NAME);
        sContactsProjectionMap.put(TContacts.PHONETIC_NAME_STYLE, TContacts.PHONETIC_NAME_STYLE);
        sContactsProjectionMap.put(TContacts.SORT_KEY_PRIMARY, TContacts.SORT_KEY_PRIMARY);
        sContactsProjectionMap.put(TContacts.SORT_KEY_ALTERNATIVE, TContacts.SORT_KEY_ALTERNATIVE);
        ...
        addProjection(sContactsProjectionMap, TContacts.CONTACT_CHAT_CAPABILITY,
                Tables.AGGREGATED_PRESENCE + "." + TStatusUpdates.CHAT_CAPABILITY);
        ...
        sContactsProjectionWithSnippetMap.put(TSearchSnippetColumns.SNIPPET_MIMETYPE,
                TSearchSnippetColumns.SNIPPET_MIMETYPE);
        sContactsProjectionWithSnippetMap.put(TSearchSnippetColumns.SNIPPET_DATA_ID,
                TSearchSnippetColumns.SNIPPET_DATA_ID);
        sContactsProjectionWithSnippetMap.put(TSearchSnippetColumns.SNIPPET_DATA1,
                TSearchSnippetColumns.SNIPPET_DATA1);
        sContactsProjectionWithSnippetMap.put(TSearchSnippetColumns.SNIPPET_DATA2,
                TSearchSnippetColumns.SNIPPET_DATA2);
        sContactsProjectionWithSnippetMap.put(TSearchSnippetColumns.SNIPPET_DATA3,
                TSearchSnippetColumns.SNIPPET_DATA3);
        sContactsProjectionWithSnippetMap.put(TSearchSnippetColumns.SNIPPET_DATA4,
        ...
        sDataProjectionMap.put(TRawContacts.NAME_VERIFIED, TRawContacts.NAME_VERIFIED);
        ...
        sDataProjectionMap.put(TContacts.DISPLAY_NAME_ALTERNATIVE,
        		TContacts.DISPLAY_NAME_ALTERNATIVE);
        sDataProjectionMap.put(TContacts.DISPLAY_NAME_SOURCE, TContacts.DISPLAY_NAME_SOURCE);
        sDataProjectionMap.put(TContacts.PHONETIC_NAME, TContacts.PHONETIC_NAME);
        sDataProjectionMap.put(TContacts.PHONETIC_NAME_STYLE, TContacts.PHONETIC_NAME_STYLE);
        sDataProjectionMap.put(TContacts.SORT_KEY_PRIMARY, TContacts.SORT_KEY_PRIMARY);
        sDataProjectionMap.put(TContacts.SORT_KEY_ALTERNATIVE, TContacts.SORT_KEY_ALTERNATIVE);
        ...
        sDataProjectionMap.put(TContacts.NAME_RAW_CONTACT_ID, TContacts.NAME_RAW_CONTACT_ID);
        ...
        addProjection(sDataProjectionMap, TData.CONTACT_CHAT_CAPABILITY,
                Tables.AGGREGATED_PRESENCE + "." + TStatusUpdates.CHAT_CAPABILITY);
        ...
        sDistinctDataProjectionMap.put(TContacts.DISPLAY_NAME_ALTERNATIVE,
        		TContacts.DISPLAY_NAME_ALTERNATIVE);
        sDistinctDataProjectionMap.put(TContacts.DISPLAY_NAME_SOURCE, TContacts.DISPLAY_NAME_SOURCE);
        sDistinctDataProjectionMap.put(TContacts.PHONETIC_NAME, TContacts.PHONETIC_NAME);
        sDistinctDataProjectionMap.put(TContacts.PHONETIC_NAME_STYLE, TContacts.PHONETIC_NAME_STYLE);
        sDistinctDataProjectionMap.put(TContacts.SORT_KEY_PRIMARY, TContacts.SORT_KEY_PRIMARY);
        ...
        addProjection(sDistinctDataProjectionMap, Contacts.CONTACT_PRESENCE,
                Tables.AGGREGATED_PRESENCE + "." + StatusUpdates.PRESENCE);
        addProjection(sDistinctDataProjectionMap, TContacts.CONTACT_CHAT_CAPABILITY,
                Tables.AGGREGATED_PRESENCE + "." + TStatusUpdates.CHAT_CAPABILITY);
        ...
        addProjection(sDistinctDataProjectionMap, Data.PRESENCE,
                Tables.PRESENCE + "." + StatusUpdates.PRESENCE);
        addProjection(sDistinctDataProjectionMap, TData.CHAT_CAPABILITY,
                Tables.PRESENCE + "." + TStatusUpdates.CHAT_CAPABILITY);
        ...
        columns.put(TStatusUpdates.CHAT_CAPABILITY, TStatusUpdates.CHAT_CAPABILITY);
    ...
    public class StructuredNameRowHandler extends DataRowHandler {
        ...
        public long insert(SQLiteDatabase db, long rawContactId, ContentValues values) {
            ...
            Integer fullNameStyle = values.getAsInteger(TStructuredName.FULL_NAME_STYLE);
        ...
        public boolean update(SQLiteDatabase db, ContentValues values, Cursor c,
            ...
            if (values.containsKey(StructuredName.DISPLAY_NAME) ||
                ...
                Integer fullNameStyle = augmented.getAsInteger(TStructuredName.FULL_NAME_STYLE);
                insertNameLookupForStructuredName(rawContactId, dataId, name,
                        fullNameStyle != null
                                ? mNameSplitter.getAdjustedFullNameStyle(fullNameStyle)
                                : TFullNameStyle.UNDEFINED);
        ...
        private void fixStructuredNameComponents(ContentValues augmented, ContentValues update) {
            ...
            if (touchedUnstruct && !touchedStruct) {
                ...
                update.put(TStructuredName.FULL_NAME_STYLE, unadjustedFullNameStyle);
                update.put(TStructuredName.PHONETIC_NAME_STYLE, name.phoneticNameStyle);
    ...
    private boolean initialize() {
        ...
        mResetNameVerifiedForOtherRawContacts = mDb.compileStatement(
                "UPDATE " + Tables.RAW_CONTACTS +
                " SET " + TRawContacts.NAME_VERIFIED + "=0" +
                " WHERE " + RawContacts.CONTACT_ID + "=(" +
                        "SELECT " + RawContacts.CONTACT_ID +
                        " FROM " + Tables.RAW_CONTACTS +
                        " WHERE " + RawContacts._ID + "=?)" +
    ...
    private void onLegacyContactImportFailure() {
        ...
        n.setLatestEventInfo(context,
                ...
                PendingIntent.getActivity(context, 0, new Intent(TContactsContract.Intents.UI.LIST_DEFAULT), 0));
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        if (mAccessLatch != null) {
            ...
            if (match == PROVIDER_STATUS && isLegacyContactImportNeeded()) {
                ...
                if (newStatus != null && newStatus == TProviderStatus.STATUS_UPGRADING) {
                    importLegacyContactsAsync();
                    return 1;
                } else {
                    return 0;
    ...
    protected void setProviderStatus(int status) {
        ...
        getContext().getContentResolver().notifyChange(TContactsContract.TProviderStatus.CONTENT_URI,
                null, false);
    }
    ...
    public void updateRawContactDisplayName(SQLiteDatabase db, long rawContactId) {
        ...
        try {
            while (c.moveToNext()) {
                ...
                if (source < bestDisplayNameSource || source == TDisplayNameSources.UNDEFINED) {
                    continue;
                }
    ...
    private int deleteData(String selection, String[] selectionArgs, boolean callerIsSyncAdapter) {
        ...
        Cursor c = query(TData.CONTENT_URI, DataDeleteQuery.COLUMNS, selection, selectionArgs, null);
        try {
            while(c.moveToNext()) {
                long rawContactId = c.getLong(DataDeleteQuery.RAW_CONTACT_ID);
    ...
    public long insertStatusUpdate(ContentValues values) {
        ...
        if (values.containsKey(StatusUpdates.PRESENCE)) {
            ...
            mValues.put(TStatusUpdates.CHAT_CAPABILITY,
                    values.getAsString(TStatusUpdates.CHAT_CAPABILITY));
    ...
    private ContentValues getSettableColumnsForPresenceTable(ContentValues values) {
        ...
        ContactsDatabaseHelper.copyStringValue(mValues, TStatusUpdates.CHAT_CAPABILITY, values,
                TStatusUpdates.CHAT_CAPABILITY);
        return mValues;
    }
        ...
        try {
            ...
            if (!accountsToDelete.isEmpty()) {
                ...
                Cursor cursor = mDb.rawQuery("SELECT " + Contacts._ID +
                        ...
                        " WHERE (" + TContacts.NAME_RAW_CONTACT_ID + " NOT NULL AND " +
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (readBooleanQueryParameter(uri, TContactCounts.ADDRESS_BOOK_INDEX_EXTRAS, false)) {
    ...
    private Cursor bundleLetterCountExtras(Cursor cursor, final SQLiteDatabase db,
        ...
        try {
            ...
            bundle.putStringArray(TContactCounts.EXTRA_ADDRESS_BOOK_INDEX_TITLES, titles);
            bundle.putIntArray(TContactCounts.EXTRA_ADDRESS_BOOK_INDEX_COUNTS, counts);
    ...
    private void setTablesAndProjectionMapForContactsWithSnippet(SQLiteQueryBuilder qb, Uri uri,
        ...
        if (mDbHelper.isInProjection(projection, TSearchSnippetColumns.SNIPPET_DATA_ID)) {
            sb.append(", " + DataColumns.CONCRETE_ID + " AS "
                    + TSearchSnippetColumns.SNIPPET_DATA_ID);
        }

        if (mDbHelper.isInProjection(projection, TSearchSnippetColumns.SNIPPET_DATA1)) {
            sb.append(", " + Data.DATA1 + " AS " + TSearchSnippetColumns.SNIPPET_DATA1);
        }

        if (mDbHelper.isInProjection(projection, TSearchSnippetColumns.SNIPPET_DATA2)) {
            sb.append(", " + Data.DATA2 + " AS " + TSearchSnippetColumns.SNIPPET_DATA2);
        }

        if (mDbHelper.isInProjection(projection, TSearchSnippetColumns.SNIPPET_DATA3)) {
            sb.append(", " + Data.DATA3 + " AS " + TSearchSnippetColumns.SNIPPET_DATA3);
        }

        if (mDbHelper.isInProjection(projection, TSearchSnippetColumns.SNIPPET_DATA4)) {
            sb.append(", " + Data.DATA4 + " AS " + TSearchSnippetColumns.SNIPPET_DATA4);
        }

        if (mDbHelper.isInProjection(projection, TSearchSnippetColumns.SNIPPET_MIMETYPE)) {
            sb.append(", (" +
                    "SELECT " + MimetypesColumns.MIMETYPE +
                    " FROM " + Tables.MIMETYPES +
                    " WHERE " + MimetypesColumns._ID + "=" + DataColumns.MIMETYPE_ID +
                    ") AS " + TSearchSnippetColumns.SNIPPET_MIMETYPE);
        }
    ...
    public String getContactsRestrictionExceptionAsNestedQuery(String contactIdColumn) {
        if (mDbHelper.hasAccessToRestrictedData()) {
            ...
            return "(SELECT " + TRawContacts.IS_RESTRICTED + " FROM " + Tables.RAW_CONTACTS
    ...
    protected boolean isWritableAccount(String accountType) {
        ...
        IContentService contentService = TMethod.getContentService();//ContentResolver.getContentService();
        try {
