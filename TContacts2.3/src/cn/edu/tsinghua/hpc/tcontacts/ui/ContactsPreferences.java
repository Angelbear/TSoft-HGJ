...
public final class ContactsPreferences extends ContentObserver {
    ...
    private int getDefaultSortOrder() {
        if (mContext.getResources().getBoolean(R.bool.config_default_sort_order_primary)) {
            return TContactsContract.TPreferences.SORT_ORDER_PRIMARY;
        } else {
            return TContactsContract.TPreferences.SORT_ORDER_ALTERNATIVE;
        }
    }
        ...
        if (mSortOrder == -1) {
            try {
                mSortOrder = Settings.System.getInt(mContext.getContentResolver(),
                		TContactsContract.TPreferences.SORT_ORDER);
    ...
    public void setSortOrder(int sortOrder) {
        ...
        Settings.System.putInt(mContext.getContentResolver(),
        		TContactsContract.TPreferences.SORT_ORDER, sortOrder);
    }
    ...
    private int getDefaultDisplayOrder() {
        if (mContext.getResources().getBoolean(R.bool.config_default_display_order_primary)) {
            return TContactsContract.TPreferences.DISPLAY_ORDER_PRIMARY;
        } else {
            return TContactsContract.TPreferences.DISPLAY_ORDER_ALTERNATIVE;
        }
    }
        ...
        if (mDisplayOrder == -1) {
            try {
                mDisplayOrder = Settings.System.getInt(mContext.getContentResolver(),
                		TContactsContract.TPreferences.DISPLAY_ORDER);
            } catch (SettingNotFoundException e) {
    ...
    public void setDisplayOrder(int displayOrder) {
        ...
        Settings.System.putInt(mContext.getContentResolver(),
        		TContactsContract.TPreferences.DISPLAY_ORDER, displayOrder);
    }
    ...
    public void registerChangeListener(ChangeListener listener) {
        ...
        contentResolver.registerContentObserver(
                Settings.System.getUriFor(
                		TContactsContract.TPreferences.SORT_ORDER), false, this);
        contentResolver.registerContentObserver(
                Settings.System.getUriFor(
                		TContactsContract.TPreferences.DISPLAY_ORDER), false, this);
    }
