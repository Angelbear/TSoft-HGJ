...
public class ContactEditorView extends BaseContactEditorView implements OnClickListener {
    ...
    protected void onFinishInflate() {
        ...
        mSecondaryOpen = res.getDrawable(InternalResource.getDrawable("expander_ic_maximized")/*com.android.internal.R.drawable.expander_ic_maximized*/);
        mSecondaryClosed = res.getDrawable(InternalResource.getDrawable("expander_ic_minimized")/*com.android.internal.R.drawable.expander_ic_minimized*/);
    ...
    public void setState(EntityDelta state, ContactsSource source, ViewIdGenerator vig) {
        ...
        if(DBG) Log.d("ContactEditorView", "----> setState() source.accountType = " + source.accountType);
        ...
        for (DataKind kind : source.getSortedDataKinds()) {
            ...
            if (StructuredName.CONTENT_ITEM_TYPE.equals(mimeType)) {
                ...
                if(DBG) Log.d("ContactEditorView ", "kind += "+kind);
                if(DBG) Log.d("ContactEditorView ", "kind.mimeType += "+kind.mimeType);
