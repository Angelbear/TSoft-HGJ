...
public class TCallLog {
     ...
     */
    public static class TCalls implements BaseColumns {
        /**
	...
	/**
	*The type of dial (voice dial, video dial).
	* <P>TypeDial: INTERGER (int)</P>
        * @hide
	*/
	...
	public static final int VIDEO_DIAL = 2;
         ...
         */
        public static Uri addCall(CallerInfo ci, Context context, String number,
                int presentation, int callType, long start, int duration, int dialType) {
            final ContentResolver resolver = context.getContentResolver();
	    ...
	    values.put(TYPE_DIAL, Integer.valueOf(dialType));
