...
package cn.edu.tsinghua.hpc.tmms.dom.smil.parser;
...
import cn.edu.tsinghua.hpc.tmms.dom.smil.parser.SmilContentHandler;
...
public class SmilXmlParser {
    ...
    private void validateDocument(SMILDocument doc) {
         ...
         * @see cn.edu.tsinghua.hpc.tmms.dom.smil.SmilDocumentImpl#getBody()
         */
        doc.getBody();

        /*
         * Calling getLayout() will create "layout" element if it is not present.
         * @see cn.edu.tsinghua.hpc.tmms.dom.smil.SmilDocumentImpl#getLayout()
         */
        doc.getLayout();
    }
}
