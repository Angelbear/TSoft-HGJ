...
public class SlideshowModel extends Model
    ...
    public static SlideshowModel createFromMessageUri(
            Context context, Uri uri) throws MmsException, InvalidHeaderValueException {
    ...
    public static PduBody getPduBody(Context context, Uri msg) throws MmsException, InvalidHeaderValueException {
