...
public class SmsProvider extends ContentProvider {
    private static final Uri NOTIFICATION_URI = Uri.parse("content://tsms");//Uri.parse("content://sms");
    private static final Uri ICC_URI = Uri.parse("content://tsms/icc");//Uri.parse("content://sms/icc");
    static final String TABLE_SMS = "sms";//TABLE_SMS = "sms"
	...
	private Cursor getSingleMessageFromIcc(String messageIndexString) {
		...
		try {
			...
			ArrayList<SmsMessage> messages = (ArrayList<SmsMessage>) getAllMessagesFromIccMethod
		...
		return withIccNotificationUri(new ArrayListCursor(ICC_COLUMNS,
				singleRow));
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        if (rowID > 0) {
            Uri uri = Uri.parse("content://" + "t"+ table + "/" + rowID);
        ...
        switch (match) {
            ...
            case SMS_CONVERSATIONS_ID:
				...
				try {
					...
					where = (String) concatenateWhereMethod.invoke(null, new Object[] {
    ...
    private int deleteMessageFromIcc(String messageIndexString) {
        ...
        try {
			...
			res = (Boolean) deleteMessageFromIccMethod
					.invoke("smsManager", new Object[] {Integer.parseInt(messageIndexString)}) ? 1 : 0;
			return res;
...
//        where = DatabaseUtils.concatenateWhere(where, extraWhere);
    ...
    private void notifyChange(Uri uri) {
        ...
        cr.notifyChange(TMmsSms.CONTENT_CONVERSATIONS_URI, null);
    }
