...
import cn.edu.tsinghua.hpc.tmms.ui.ConversationList;
...
public class MessagingNotification {
    ...
    private static final Uri UNDELIVERED_URI = 
    	Uri.withAppendedPath(TMmsSms.AUTHORITY_URI, "undelivered");
    ...
    public static final MmsSmsNotificationInfo getMmsNewMessageNotificationInfo(
        ...
        Cursor cursor = SqliteWrapper.query(context, resolver, TMms.CONTENT_URI,
        ...
        try {
            ...
            Uri msgUri = TMms.CONTENT_URI.buildUpon().appendPath(
    ...
    public static final MmsSmsDeliveryInfo getSmsNewDeliveryInfo(
	    Context context) {
	ContentResolver resolver = context.getContentResolver();
	Cursor cursor = SqliteWrapper.query(context, resolver, TSms.CONTENT_URI,
	...
	if (!sp.getBoolean(
		    MessagingPreferenceActivity.NOTIFICATION_ENABLED, false))
	    return;
    ...
    private static void updateNotification(
        ...
        if (!sp.getBoolean(MessagingPreferenceActivity.NOTIFICATION_ENABLED, false)) {
            return;
        }
    ...
    private static void notifyFailed(Context context, boolean isDownload, long threadId,
        ...
        boolean enabled = sp.getBoolean(MessagingPreferenceActivity.NOTIFICATION_ENABLED, false);
        if (!enabled) {
            return;
        }
