...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public void run() {
		...
		try {
			...
			dataSuspended = (Integer) getDefaultMethod.invoke(null,
					new Object[] {}) == TelephonyManager.DATA_SUSPENDED;
		} catch (Exception e) {
...
//        boolean dataSuspended = (TelephonyManager.getDefault().getDataState() );
        try {
            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, TMms.TInbox.CONTENT_URI);
    ...
    private void sendNotifyRespInd(int status) throws MmsException, IOException, InvalidHeaderValueException {
