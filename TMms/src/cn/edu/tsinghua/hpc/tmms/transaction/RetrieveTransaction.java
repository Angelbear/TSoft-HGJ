...
public class RetrieveTransaction extends Transaction implements Runnable {
    ...
    /*
     * (non-Javadoc)
     * @see cn.edu.tsinghua.hpc.tmms.transaction.Transaction#process()
     */
    @Override
    public void process() {
    ...
    public void run() {
        try {
            ...
            if (isDuplicateMessage(mContext, retrieveConf)) {
                ...
                msgUri = persister.persist(retrieveConf, TMms.TInbox.CONTENT_URI);
    ...
    private void sendAcknowledgeInd(RetrieveConf rc) throws MmsException, IOException, InvalidHeaderValueException {
