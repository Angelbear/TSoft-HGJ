...
import cn.edu.tsinghua.hpc.tmms.util.TTelephony.TConnectivityManager;
...
public class RetryScheduler implements Observer {
    ...
    private boolean isConnected() {
        ...
        return (mConnMgr.getNetworkInfo(TConnectivityManager.TYPE_MOBILE_MMS).
                isConnected());
    }
    ...
    private void scheduleRetry(Uri uri) {
        ...
        Uri.Builder uriBuilder = TMmsSms.TPendingMessages.CONTENT_URI.buildUpon();
            ...
            try {
                if ((cursor.getCount() == 1) && cursor.moveToFirst()) {
                    ...
                    SqliteWrapper.update(mContext, mContentResolver,
                    		TMmsSms.TPendingMessages.CONTENT_URI,
    ...
    private int getResponseStatus(long msgID) {
        int respStatus = 0;
        Cursor cursor = SqliteWrapper.query(mContext, mContentResolver,
                TMms.TOutbox.CONTENT_URI, null, Mms._ID + "=" + msgID, null, null);
        try {
