...
public class SmsReceiverService extends Service {
    ...
    public static final String MESSAGE_SENT_ACTION =
        "cn.edu.tsinghua.hpc.tmms.transaction.MESSAGE_SENT";
...
//        }
    ...
    private void handleServiceStateChanged(Intent intent) {
		...
		try {
			...
			ServiceState serviceState = (ServiceState) newFromBundleMethod
					.invoke(null, new Object[] { intent.getExtras() });
			// ServiceState serviceState =
			// ServiceState.newFromBundle(intent.getExtras());
    ...
    public synchronized void sendFirstQueuedMessage() {
        ...
        final Uri uri = 
        	Uri.withAppendedPath(TSms.AUTHORITY_URI, "queued");
    ...
    private void moveOutboxMessagesToQueuedBox() {
        ...
        SqliteWrapper.update(
                getApplicationContext(), getContentResolver(), TSms.TOutbox.CONTENT_URI,
    ...
    private Uri insertMessage(Context context, SmsMessage[] msgs) {
        ...
        if (sms.getMessageClass() == SmsMessage.MessageClass.CLASS_0) {
            ...
            result = replaceMessage(context, msgs);
            MmsUtils.markMessageSyncDirty(context, result, 1);
            return result;
        } else {
            result =  storeMessage(context, msgs);
    ...
    private Uri replaceMessage(Context context, SmsMessage[] msgs) {
        ...
        Cursor cursor = SqliteWrapper.query(context, resolver, TSms.TInbox.CONTENT_URI,
    ...
    private Uri storeMessage(Context context, SmsMessage[] msgs) {
        ...
        Uri insertedUri = SqliteWrapper.insert(context, resolver, TSms.TInbox.CONTENT_URI, values);
