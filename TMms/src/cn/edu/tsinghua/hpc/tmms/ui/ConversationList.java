...
public class ConversationList extends ListActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		// TODO 检查TContact是否已经安装 by mawen
		TIntent.checkTContacts(mContext);
		// TODO 请求窗口特色风格，这里设置成不明确的进度风格 by mawen
		requestWindowFeature(Window.FEATURE_INDETERMINATE_PROGRESS);
		setContentView(R.layout.conversation_list_screen);

		mQueryHandler = new ThreadListQueryHandler(getContentResolver());

		// TODO 设置短信列表界面整体样式 by mawen
	...
	// TODO 处理同步消息对话框的handler by mawen
