...
//					Log.v(TAG,"uri========="+ uri);
		...
		//add by chenqiang
//		for(int i = 0; i<RecoverActivityListAdapter.smsID.size(); i++)    { 
//			int msgid = RecoverActivityListAdapter.smsID.get(i);
//			Uri uri = null;
////			String type  = RecoverActivityListAdapter.typeList.get(i);
////			if(type.equals("sms")){
//				uri = ContentUris.withAppendedId(TSms.CONTENT_URI, msgid);
////			}else if(type.equals("mms")){
////				uri = ContentUris.withAppendedId(TMms.CONTENT_URI, msgid);
////			}
//			if (uri != null) {
//				ContentValues values = new ContentValues();
//				values.put("sync_state", SyncState.SYNC_STATE_RECOVER);
//				mQueryHandler.startUpdate(TOKEN_UNDELET_MESSEAGES, null, uri, values, null, null);
//			}
//		}
//		for(CheckBox cb:RecoverActivityListAdapter.cblist){
//			cb.setChecked(false);
//		}
//		finish();
	}
