...
package cn.edu.tsinghua.hpc.tmms.ui.widget;
...
import cn.edu.tsinghua.hpc.tmms.util.TContactsContract.TContacts;
...
public class ContactHeaderWidget extends FrameLayout implements View.OnClickListener {
    ...
    public ContactHeaderWidget(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPhotoView = (QuickContactBadge) findViewById(cn.edu.tsinghua.hpc.tmms.R.id.photo);
        ...
        if (num < 9) {
            ...
            mNoPhotoResource = com.android.internal.R.drawable.ic_contact_picture_2;
        } else {
            // Coming in from the top, rare
            mNoPhotoResource = com.android.internal.R.drawable.ic_contact_picture_3;
        }
                ...
                switch (token) {
                    ...
                    case TOKEN_CONTACT_INFO: {
                        if (cursor != null && cursor.moveToFirst()) {
                            ...
                            Uri lookupUri = TContacts.getLookupUri(cursor.getLong(ContactQuery._ID),
                    ...
                    case TOKEN_PHONE_LOOKUP: {
                        if (cursor != null && cursor.moveToFirst()) {
                            ...
                            bindFromContactUriInternal(TContacts.getLookupUri(contactId, lookupKey),
    ...
    public void bindFromEmail(String emailAddress) {
        ...
        mQueryHandler.startQuery(TOKEN_EMAIL_LOOKUP, emailAddress,
                Uri.withAppendedPath(TEmail.getLookupUri(), Uri.encode(emailAddress)),
    ...
    public void bindFromPhoneNumber(String number) {
        ...
        mQueryHandler.startQuery(TOKEN_PHONE_LOOKUP, number,
                Uri.withAppendedPath(TPhoneLookup.getFilterUri(), Uri.encode(number)),
    ...
    protected void startPhotoQuery(long photoId, Uri lookupKey, boolean resetQueryHandler) {
        ...
        Uri tempUri = TData.getContentUri();
        
        mQueryHandler.startQuery(TOKEN_PHOTO_QUERY, lookupKey,
                ContentUris.withAppendedId(tempUri, photoId), PhotoQuery.COLUMNS,
                null, null, null);
    }
