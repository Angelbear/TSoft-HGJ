...
import cn.edu.tsinghua.hpc.tmms.util.TContactsContract.TIntents;
import cn.edu.tsinghua.hpc.tmms.util.TContactsContract.TPhoneLookup;
import cn.edu.tsinghua.hpc.tmms.util.TContactsContract.TQuickContact;
    ...
    private class QueryHandler extends AsyncQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            if (trigger && lookupUri != null) {
                ...
                final Intent intent = new Intent(TIntents.getSHOW_OR_CREATE_CONTACT(getContext()), createUri);
