...
package cn.edu.tsinghua.hpc.google.tmms.util;
...
import cn.edu.tsinghua.hpc.google.tmms.util.AbstractCache;
...
public final class PduCache extends AbstractCache<Uri, PduCacheEntry> {
    ...
    static {
    	...
    	String mmsSmsAuthority = TMmsSms.AUTHORITY;
        URI_MATCHER = new UriMatcher(UriMatcher.NO_MATCH);
        URI_MATCHER.addURI(mmsAuthority, null,         MMS_ALL);
        URI_MATCHER.addURI(mmsAuthority, "#",          MMS_ALL_ID);
        URI_MATCHER.addURI(mmsAuthority, "inbox",      MMS_INBOX);
        URI_MATCHER.addURI(mmsAuthority, "inbox/#",    MMS_INBOX_ID);
        URI_MATCHER.addURI(mmsAuthority, "sent",       MMS_SENT);
        URI_MATCHER.addURI(mmsAuthority, "sent/#",     MMS_SENT_ID);
        URI_MATCHER.addURI(mmsAuthority, "drafts",     MMS_DRAFTS);
        URI_MATCHER.addURI(mmsAuthority, "drafts/#",   MMS_DRAFTS_ID);
        URI_MATCHER.addURI(mmsAuthority, "outbox",     MMS_OUTBOX);
        URI_MATCHER.addURI(mmsAuthority, "outbox/#",   MMS_OUTBOX_ID);
        URI_MATCHER.addURI(mmsSmsAuthority, "conversations",   MMS_CONVERSATION);
        URI_MATCHER.addURI(mmsSmsAuthority, "conversations/#", MMS_CONVERSATION_ID);
    ...
    synchronized public PduCacheEntry purge(Uri uri) {
        ...
        switch (match) {
            ...
            case MMS_OUTBOX_ID:
                ...
                return purgeSingleEntry(Uri.withAppendedPath(TMms.CONTENT_URI, msgId));
    ...
    private Uri normalizeKey(Uri uri) {
        ...
        switch (match) {
            ...
            case MMS_OUTBOX_ID:
                String msgId = uri.getLastPathSegment();
                normalizedKey = Uri.withAppendedPath(TMms.CONTENT_URI, msgId);
                break;
            default:
                return null;
        }
