...
public class SuggestionsProvider extends android.content.ContentProvider {
    ...
    final static String AUTHORITY = "cn.edu.tsinghua.hpc.tmms.SuggestionsProvider";//"com.android.mms.SuggestionsProvider";
//    final static int MODE = DATABASE_MODE_QUERIES + DATABASE_MODE_2LINES;
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Uri u = Uri.parse(String.format(
                "content://"+TMmsSms.AUTHORITY+"/searchSuggest?pattern=%s",
                selectionArgs[0]));
        ...
        public String getString(int column) {
            ...
            switch (column - mColumnCount) {
                case INTENT_DATA_COLUMN:
                    Uri u = Uri.parse("content://"+TMmsSms.AUTHORITY+"/search").buildUpon().appendQueryParameter("pattern", row.getWord()).build();
                    return u.toString();
