...
//    };
    ...
    public synchronized Uri getUri() {
        return ContentUris.withAppendedId(TContacts.CONTENT_URI, mPersonId);
    }
    ...
    private static class ContactsCache {
        ...
        private static final Uri PHONES_WITH_PRESENCE_URI = TData.CONTENT_URI;
        ...
        private static final Uri EMAIL_WITH_PRESENCE_URI = TData.CONTENT_URI;
        ...
        private byte[] loadAvatarData(Contact entry) {
            ...
            Uri contactUri = ContentUris.withAppendedId(TContacts.CONTENT_URI, entry.mPersonId);
