...
public class MmsProvider extends ContentProvider {
    ...
    static final String TABLE_DATA = "mms_data";
    ...
    public Cursor query(Uri uri, String[] projection,
        ...
        switch (match) {
    		...
    		case MMS_DATA_ID:
    			qb.setTables(TABLE_DATA);
    			qb.appendWhere("mms_id = " + uri.getLastPathSegment());
    			break;
            default:
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (table.equals(TABLE_PDU)) {
            ...
            if (((threadId == null) || (threadId == 0)) && (address != null)) {
                finalValues.put(Mms.THREAD_ID, TThreads.getOrCreateThreadId(getContext(), address));
            }
    ...
    public int delete(Uri uri, String selection,
        ...
        switch (match) {
    		...
    		case MMS_DATA_ID:
    			table = TABLE_DATA;
    			extraSelection = "mms_id = " + uri.getLastPathSegment();
    			break;
            default:
    ...
    private static final int MMS_DATA 					  = 21;
	private static final int MMS_DATA_ID 				  = 22;

    private static final UriMatcher
            sURLMatcher = new UriMatcher(UriMatcher.NO_MATCH);

    static {
    	String mmsAuthority = TMms.AUTHORITY;
        sURLMatcher.addURI(mmsAuthority, null,         MMS_ALL);
        sURLMatcher.addURI(mmsAuthority, "#",          MMS_ALL_ID);
        sURLMatcher.addURI(mmsAuthority, "inbox",      MMS_INBOX);
        sURLMatcher.addURI(mmsAuthority, "inbox/#",    MMS_INBOX_ID);
        sURLMatcher.addURI(mmsAuthority, "sent",       MMS_SENT);
        sURLMatcher.addURI(mmsAuthority, "sent/#",     MMS_SENT_ID);
        sURLMatcher.addURI(mmsAuthority, "drafts",     MMS_DRAFTS);
        sURLMatcher.addURI(mmsAuthority, "drafts/#",   MMS_DRAFTS_ID);
        sURLMatcher.addURI(mmsAuthority, "outbox",     MMS_OUTBOX);
        sURLMatcher.addURI(mmsAuthority, "outbox/#",   MMS_OUTBOX_ID);
        sURLMatcher.addURI(mmsAuthority, "part",       MMS_ALL_PART);
        sURLMatcher.addURI(mmsAuthority, "#/part",     MMS_MSG_PART);
        sURLMatcher.addURI(mmsAuthority, "part/#",     MMS_PART_ID);
        sURLMatcher.addURI(mmsAuthority, "#/addr",     MMS_MSG_ADDR);
        sURLMatcher.addURI(mmsAuthority, "rate",       MMS_SENDING_RATE);
        sURLMatcher.addURI(mmsAuthority, "report-status/#",  MMS_REPORT_STATUS);
        sURLMatcher.addURI(mmsAuthority, "report-request/#", MMS_REPORT_REQUEST);
        sURLMatcher.addURI(mmsAuthority, "drm",        MMS_DRM_STORAGE);
        sURLMatcher.addURI(mmsAuthority, "drm/#",      MMS_DRM_STORAGE_ID);
        sURLMatcher.addURI(mmsAuthority, "threads",    MMS_THREADS);
        sURLMatcher.addURI(mmsAuthority, "scrapSpace", MMS_SCRAP_SPACE);
        sURLMatcher.addURI(mmsAuthority, "data", 		MMS_DATA);
		sURLMatcher.addURI(mmsAuthority, "data/#", 	MMS_DATA_ID);
    }
