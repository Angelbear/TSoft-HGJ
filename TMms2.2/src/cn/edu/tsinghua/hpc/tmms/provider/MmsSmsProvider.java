...
public class MmsSmsProvider extends ContentProvider {
	...
	private static final int URI_CONVERSATIONS_THREADS = 18;
	private static final int URI_ALL_THREADS = 19;
    ...
    private static final String AUTHORITY = TMmsSms.AUTHORITY;//"mms-sms";
    ...
    public Cursor query(Uri uri, String[] projection,
        ...
        cursor.setNotificationUri(getContext().getContentResolver(), TMmsSms.CONTENT_URI);
        return cursor;
    }
    ...
    private void insertThread(String recipientIds, int numberOfRecipients) {
        ...
        getContext().getContentResolver().notifyChange(TMmsSms.CONTENT_URI, null);
    }
