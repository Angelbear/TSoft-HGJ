...
import static cn.edu.tsinghua.hpc.tmms.transaction.TransactionState.FAILED;
import static cn.edu.tsinghua.hpc.tmms.transaction.TransactionState.INITIALIZED;
import static cn.edu.tsinghua.hpc.tmms.transaction.TransactionState.SUCCESS;
import static cn.edu.tsinghua.hpc.google.tmms.pdu.PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF;
import static cn.edu.tsinghua.hpc.google.tmms.pdu.PduHeaders.STATUS_DEFERRED;
import static cn.edu.tsinghua.hpc.google.tmms.pdu.PduHeaders.STATUS_RETRIEVED;
import static cn.edu.tsinghua.hpc.google.tmms.pdu.PduHeaders.STATUS_UNRECOGNIZED;
...
import cn.edu.tsinghua.hpc.tmms.syncaction.StringEncoder;
...
import cn.edu.tsinghua.hpc.tmms.util.TTelephony.TMms.TInbox;
...
import cn.edu.tsinghua.hpc.google.tmms.pdu.NotifyRespInd;
...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    /*
     * (non-Javadoc)
     * @see cn.edu.tsinghua.hpc.google.tmms.pdu.Transaction#process()
     */
    @Override
    public void process() {
        ...
        try {
            ...
            if (retrieveConfData != null) {
                ...
                if ((pdu == null) || (pdu.getMessageType() != MESSAGE_TYPE_RETRIEVE_CONF)) {
                    ...
                    Uri uri = p.persist(pdu, TInbox.CONTENT_URI);
                    ...
                    values.put("mms_id", id);
                    values.put("data", StringEncoder.encode(retrieveConfData));
                    mContext.getContentResolver().insert(mmsdataUri, values);
                    //MmsUtils.notifySyncService(mContext);
