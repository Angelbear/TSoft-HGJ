...
public class MessageItem {
    ...
    MessageItem(Context context, String type, Cursor cursor,
        ...
        if ("sms".equals(type)) {
            ...
            mMessageUri = ContentUris.withAppendedId(TSms.CONTENT_URI, mMsgId);
            ...
            //Log.d(TAG , String.valueOf(columnsMap.mColumnSmsAddress));
            //Log.d(TAG , String.valueOf(cursor.getColumnIndex("address")));
            //Log.d(TAG , mAddress +" "+ cursor.getString(cursor.getColumnIndex("address")));
            ...
            mMessageUri = ContentUris.withAppendedId(TMms.CONTENT_URI, mMsgId);
