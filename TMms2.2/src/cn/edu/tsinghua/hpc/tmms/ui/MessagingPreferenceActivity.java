 ...
 */
public class MessagingPreferenceActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (preference == mSmsLimitPref) {
            new NumberPickerDialog(this,
                    ...
                    R.string.pref_text_messages_to_save).show();
			...
			new NumberPickerDialog(this, mSetThreadLimitListener,
					getThreadLimit(), 5, 50,
					R.string.set_thread_limit,R.string.pref_threads_to_save).show();
		}
