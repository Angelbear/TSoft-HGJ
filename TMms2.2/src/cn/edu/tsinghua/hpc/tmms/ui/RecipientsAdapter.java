...
import cn.edu.tsinghua.hpc.tmms.provider.ArrayListCursor;
import cn.edu.tsinghua.hpc.tmms.util.TContactsContract.TPhone;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    public final CharSequence convertToString(Cursor cursor) {
        ...
        //Phone.getDisplayLabel(mContext, type, label);
    ...
    public final void bindView(View view, Context context, Cursor cursor) {
        ...
        CharSequence labelText = Phone.getTypeLabel(mContext.getResources(), type, 
        	//Phone.getDisplayLabel(mContext, type,
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        ...
        Uri uri = Uri.withAppendedPath(TPhone.CONTENT_FILTER_URI, Uri.encode(cons));
        /*
